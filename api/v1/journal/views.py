...
class JournalGroupListView(generics.ListCreateAPIView):
    """Виведення оцінок групи по дисципліні, додавання оцінки студенту"""
...
class ScoreView(generics.RetrieveUpdateDestroyAPIView):
    """Перегляд-оновлення-видалення оцінки студента"""
...
class JournalStudentListView(generics.ListAPIView):
    """Вивід оцінок по всім предметам конкретного студента"""
    serializer_class = ScoreSerializer
